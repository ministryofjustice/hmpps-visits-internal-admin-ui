...
import { IncentiveLevelGroup, CategoryGroup } from '../../../data/visitSchedulerApiTypes'
...
beforeEach(() => {
  ...
  app = appWithAllRoutes({
    services: { prisonService, sessionTemplateService, incentiveGroupService, categoryGroupService },
  })
})
