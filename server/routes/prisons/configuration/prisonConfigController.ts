...
export default class PrisonConfigController {
  ...
  public contactDetailsView(): RequestHandler {
    return async (req, res) => {
  ...
  public contactDetailsAddSubmit(): RequestHandler {
    return async (req, res) => {
      const { prisonId } = req.params
  ...
  public contactDetailsEditSubmit(): RequestHandler {
    return async (req, res) => {
      const { prisonId } = req.params
  ...
  public validateContactDetails(): ValidationChain[] {
    return [
