...
export interface paths {
  ...
  "/api/offences/update-active-flag": {
    /** Requires NOMIS_OFFENCE_ACTIVATOR role */
  ...
  "/api/education/prisoners": {
    /** A list of offender educations given a list of offender identifiers */
  ...
  "/api/case-notes/usage-by-types": {
    /** Retrieves list of case notes grouped by type/sub and offender<p>This endpoint uses the REPLICA database.</p> */
...
export interface operations {
  ...
  updateOffenceActiveFlag: {
    responses: {
      /** The active flag has been updated successfully */
      200: unknown;
      /** Unrecoverable error occurred whilst processing request. */
      500: unknown;
    };
  ...
  getPrisonerEducations: {
    parameters: {
      path: {
        /** The offender NOMS number. NOMS numbers have the format:<b>G0364GX</b> */
        offenderNo: string;
      };
      query: {
        /** The page number of the paged results */
  ...
  getCourtDateResults: {
    parameters: {
      path: {
        /** The required offender id (mandatory) */
        offenderId: string;
      };
    };
    responses: {
      /** The court date results. */
      200: {
        content: {
